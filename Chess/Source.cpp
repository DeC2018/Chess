...
void Initialize(SDL_Window*& window, SDL_Renderer*& render, SDL_Texture*& map, SDL_Texture*& pieces, SDL_Texture*& frames, SDL_Texture*& sidebar, SDL_Texture*& icons, SDL_Texture*& mate){
	...
	pieces = IMG_LoadTexture(render, "Piecess.png");
	frames = IMG_LoadTexture(render, "Frames.png");
	icons = IMG_LoadTexture(render, "Sidebar_Icons.png");
	mate = IMG_LoadTexture(render, "Checkmate.png");
}
